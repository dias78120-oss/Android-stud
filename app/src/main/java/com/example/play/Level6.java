...
import com.example.play.CoinManager;
...
public class Level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //код который скургляет углы правой картинки
        ...
        background.setImageResource(R.drawable.background5__);
        ...
        //Устанвливаем фон диалогового окна - начало
        LinearLayout dialogfonEnd = (LinearLayout)dialogEnd.findViewById(R.id.dialogfon);
        dialogfonEnd.setBackgroundResource(R.drawable.backpreview5_);
        //Устанавливаем фон диалогового окна - конец
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    //Вернуться назад к выбору уровня - начал
                    Intent intent = new Intent(Level6.this, GameLevels.class); //Создали намерение для перехода
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction()==MotionEvent.ACTION_DOWN) {
                    ...
                    if(array.strong[numLeft]<array.strong[numRight]) {
                        ...
                        //Определяем прввильные ответы и закрашываем зеленым - начало
                        for(int i=0; i<count; i++) {
                            TextView tv = findViewById(progress [i]);
                            tv.setBackgroundResource(R.drawable.style_points_green);
                        }
                        //Определяем прввильные ответы и закрашываем зеленым - конец
                    ...
                    if(count==20) {
                        CoinManager.addCoin(Level6.this, LEVEL_NUMBER);
