        ...
        img_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction()==MotionEvent.ACTION_DOWN) {
                    ...
                    if(count==20) {
                        CoinManager.addCoin(Level10.this, LEVEL_NUMBER);

                        //ВЫХОД ИЗ УРОВНЯ
                        dialogEnd.show();

                    }else{
                        numLeft = random.nextInt(20); // Генерируем случайное число от
                        img_left.setImageResource(array.images7[numLeft]); //Достаем из массива картинку
